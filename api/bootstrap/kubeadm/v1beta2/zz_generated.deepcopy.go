...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KubeadmBaseConfig) DeepCopyInto(out *KubeadmBaseConfig) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KubeadmBaseConfig.
func (in *KubeadmBaseConfig) DeepCopy() *KubeadmBaseConfig {
	if in == nil {
		return nil
	}
	out := new(KubeadmBaseConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *KubeadmConfigSpec) DeepCopyInto(out *KubeadmConfigSpec) {
	*out = *in
	in.KubeadmBaseConfig.DeepCopyInto(&out.KubeadmBaseConfig)
	if in.Files != nil {
