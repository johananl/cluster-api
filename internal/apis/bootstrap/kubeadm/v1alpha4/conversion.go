...
func Convert_v1beta1_KubeadmConfigSpec_To_v1alpha4_KubeadmConfigSpec(in *bootstrapv1.KubeadmConfigSpec, out *KubeadmConfigSpec, s apiconversion.Scope) error {
	...
	if in.ClusterConfiguration != nil {
		...
		if err := Convert_v1beta1_ClusterConfiguration_To_v1alpha4_ClusterConfiguration(in.ClusterConfiguration, out.ClusterConfiguration, s); err != nil {
			return err
		}
	} else {
	...
	if in.InitConfiguration != nil {
		...
		if err := Convert_v1beta1_InitConfiguration_To_v1alpha4_InitConfiguration(in.InitConfiguration, out.InitConfiguration, s); err != nil {
			return err
		}
	} else {
	...
	if in.JoinConfiguration != nil {
		...
		if err := Convert_v1beta1_JoinConfiguration_To_v1alpha4_JoinConfiguration(in.JoinConfiguration, out.JoinConfiguration, s); err != nil {
			return err
		}
	} else {
...
func Convert_v1alpha4_KubeadmConfigSpec_To_v1beta1_KubeadmConfigSpec(in *KubeadmConfigSpec, out *bootstrapv1.KubeadmConfigSpec, s apiconversion.Scope) error {
	if in.ClusterConfiguration != nil {
		out.ClusterConfiguration = &v1beta1.ClusterConfiguration{}
		if err := Convert_v1alpha4_ClusterConfiguration_To_v1beta1_ClusterConfiguration(in.ClusterConfiguration, out.ClusterConfiguration, s); err != nil {
			return err
		}
	} else {
		out.ClusterConfiguration = nil
	...
	if in.InitConfiguration != nil {
		...
		if err := Convert_v1alpha4_InitConfiguration_To_v1beta1_InitConfiguration(in.InitConfiguration, out.InitConfiguration, s); err != nil {
			return err
		}
	} else {
		out.InitConfiguration = nil
	...
	if in.JoinConfiguration != nil {
		...
		if err := Convert_v1alpha4_JoinConfiguration_To_v1beta1_JoinConfiguration(in.JoinConfiguration, out.JoinConfiguration, s); err != nil {
			return err
		}
	} else {
		out.JoinConfiguration = nil
